...
WHATSAPP_ENABLED = _env("WHATSAPP_ENABLED", "false").lower() == "true"
WHATSAPP_BRIDGE_URL = _env("WHATSAPP_BRIDGE_URL", "http://127.0.0.1:3001")
WHATSAPP_BRIDGE_TOKEN = _env("WHATSAPP_BRIDGE_TOKEN", "")
WHATSAPP_SESSION_NAME = _env("WHATSAPP_SESSION_NAME", "ninoclaw")
WHATSAPP_ALLOWED_SENDERS = _env("WHATSAPP_ALLOWED_SENDERS", "")
WHATSAPP_AUTO_START_BRIDGE = _env("WHATSAPP_AUTO_START_BRIDGE", "true").lower() == "true"
WHATSAPP_BRIDGE_COMMAND = _env("WHATSAPP_BRIDGE_COMMAND", "")
WHATSAPP_BRIDGE_TYPE = _env("WHATSAPP_BRIDGE_TYPE", "baileys")
WHATSAPP_WEBHOOK_HOST = _env("WHATSAPP_WEBHOOK_HOST", "127.0.0.1")
WHATSAPP_WEBHOOK_PORT = int(_env("WHATSAPP_WEBHOOK_PORT", "8091"))
WHATSAPP_WEBHOOK_PATH = _env("WHATSAPP_WEBHOOK_PATH", "/whatsapp/webhook")
WHATSAPP_WEBHOOK_URL = _env("WHATSAPP_WEBHOOK_URL", "")
WHATSAPP_WEBHOOK_SECRET = _env("WHATSAPP_WEBHOOK_SECRET", "")
